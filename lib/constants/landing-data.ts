...
export const agentPersonas: AgentPersona[] = [
  {
    ...
    description: "Answers calls, books appointments, handles insurance questions, and routes urgent calls to the right provider.",
  ...
  },
  {
    ...
    description: "Qualifies leads, provides estimates, schedules consultations, and follows up with interested prospects automatically.",
  ...
  },
  {
    ...
    industry: "SaaS & Tech",
    description: "Resolves common issues, walks through troubleshooting, escalates complex problems, and sends follow-up summaries.",
  ...
  },
  {
    ...
    description: "Handles reservations, answers property questions, manages scheduling, and provides personalized recommendations.",
  ...
  },
  {
    ...
    description: "Conducts initial consultations, gathers case details, assesses urgency, and schedules attorney meetings.",
  ...
  },
  {
    ...
    description: "Never miss a call again. Handles everything after hours — emergencies, messages, appointments, and lead capture.",
